    ...
    <div className="h-screen w-full font-sans text-slate-800 relative overflow-hidden bg-gradient-to-br from-blue-50 via-white to-indigo-50 flex items-center justify-center p-4">
      ...
      <div className="relative z-10 w-full max-w-lg">
        ...
        <div className="bg-white/80 backdrop-blur-xl rounded-2xl shadow-2xl border border-white/50 overflow-hidden">
          ...
          <div className="p-8">
            <h2 className="text-xl font-bold text-center text-slate-800 mb-1">Welcome to NotesSnipt</h2>
            <p className="text-center text-slate-500 text-xs mb-6">Access and manage your code snippets anywhere.</p>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div>
                <div className="flex items-center justify-between mb-1.5">
                  ...
                  <Link 
                    to="/forgot-password" 
                    className="text-[11px] font-bold text-[#6C92F4] hover:text-blue-700 transition-colors"
                  >
                    Forgot Password?
                  </Link>
                </div>
            ...
            <p className="mt-6 text-center text-xs text-slate-500">
              ...
              <Link
                to="/signup"
                className="font-bold text-[#6C92F4] hover:text-blue-600 hover:underline"
              >
                Sign up
              </Link>
            </p>
